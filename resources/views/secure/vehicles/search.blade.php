...
<h2>
    ...
    <a class="btn btn-info" href="{{ route('secure.vehicles.export', $request) }}"><i class="fa fa-export"></i> Export</a>
    <a class="btn btn-warning" href="{{ route('secure.vehicles.import') }}"><i class="fa fa-export"></i> Import</a>
