...
<div class="container-fluid">
	<div class="row">
	    <div class="col-md-12">
	        ...
	        {!! Form::open(['route' => 'secure.inventories.store', 'files' => true, 'role' => 'form', 'class' => 'form-horizontal']) !!}
                @include('secure.inventories.form', ['legend' => 'Manage Record', 'submit_text' => 'Add Record', 'list_link' => route('secure.inventories.index')])
	        {!! Form::close() !!}
	        </div>
	    </div>
	</div>
