...
<h2>
    ...
    <a class="btn btn-info" href="{{ route('secure.on-road-prices.export', $request) }}"><i class="fa fa-export"></i> Export</a>
    <a class="btn btn-warning" href="{{ route('secure.on-road-prices.import', $request) }}"><i class="fa fa-export"></i> Import</a>
