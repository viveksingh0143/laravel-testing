...
<h2>
    ...
    <a class="btn btn-info" href="{{ route('secure.dealers.used_vehicles.export', $request) }}"><i class="fa fa-export"></i> Export</a>
    <a class="btn btn-warning" href="{{ route('secure.dealers.used_vehicles.import', $request) }}"><i class="fa fa-export"></i> Import</a>
