...
<div class="container-fluid">
	<div class="row">
	    <div class="col-md-12">
	        @include('secure.used_vehicles.vehicle_list_search', ['legend' => 'Vehicle Selection'])
	            ...
	            <tbody>
	                @foreach($vehicles as $vehicle)
                        <tr>
							...
							<td><a href="{{ route('secure.dealers.used_vehicles.create_from', [$dealer->id, $vehicle->id]) }}"><i class="fa fa-dot-circle-o"></i> Select</a></td>
                        </tr>
	                @endforeach
	            </tbody>
	            <tfoot>
