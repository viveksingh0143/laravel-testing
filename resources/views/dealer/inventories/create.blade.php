...
<div class="container-fluid">
	<div class="row">
	    <div class="col-md-12">
	        ...
	        {!! Form::open(['route' => 'dealer.inventories.store', 'files' => true, 'role' => 'form', 'class' => 'form-horizontal']) !!}
                @include('dealer.inventories.form', ['legend' => 'Manage Record', 'submit_text' => 'Add Record', 'list_link' => route('dealer.inventories.index')])
	        {!! Form::close() !!}
	        </div>
	    </div>
	</div>
