                ...
                <div class="panel-body">
                    <table class="table table-striped">
                        ...
                        <tr>
                            <td colspan="2">
                                <ul class="btn-list">
                                    <li><a class="btn btn-primary" href="{{ route('dealer.inventories.index') }}"><i class="fa fa-table"></i></a></li>
                                    <li><a class="btn btn-warning" href="{{ route('dealer.inventories.edit', $inventory->id) }}"><i class="fa fa-pencil"></i></a></li>
                                </ul>
                            </td>
                        </tr>
                    </table>
