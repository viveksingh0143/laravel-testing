...
<h2>
    ...
    <a class="btn btn-info" href="{{ route('dealer.dealers.new_vehicles.export', $request) }}"><i class="fa fa-export"></i> Export</a>
    <a class="btn btn-warning" href="{{ route('dealer.dealers.new_vehicles.import', $request) }}"><i class="fa fa-export"></i> Import</a>
