...
<div class="container-fluid">
	<div class="row">
	    <div class="col-md-12">
	        @include('dealer.new_vehicles.vehicle_list_search', ['legend' => 'Vehicle Selection'])
	            ...
	            <tbody>
	                @foreach($vehicles as $vehicle)
                        <tr>
							...
							<td><a href="{{ route('dealer.dealers.new_vehicles.create_from', [$dealer->id, $vehicle->id]) }}"><i class="fa fa-dot-circle-o"></i> Select</a></td>
                        </tr>
	                @endforeach
	            </tbody>
	            <tfoot>
