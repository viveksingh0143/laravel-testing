...
<div class="container-fluid">
	<div class="row">
	    <div class="col-md-12">
			<h3>{{ $dealer->name }}</h3>
	        @include('dealer.new_vehicles.search', ['legend' => 'Manage New Vehicles', 'new_link' => route('dealer.dealers.new_vehicles.create', [$dealer->id])])
	            ...
	            <tbody>
	                @foreach($new_vehicles as $new_vehicle)
                        <tr>
							...
							<td><a href="{{ route('dealer.dealers.new_vehicles.show', [$dealer->id, $new_vehicle->id]) }}"><i class="fa fa-eye"></i> View </a></td>
                            <td><a href="{{ route('dealer.dealers.new_vehicles.edit', [$dealer->id, $new_vehicle->id]) }}"><i class="fa fa-pencil-square"></i> Edit </a></td>
                            <td><a href="{{ route('dealer.dealers.new_vehicles.destroy', [$dealer->id, $new_vehicle->id]) }}" data-method="delete" data-confirm="Are you sure to delete this user?"><i class="fa fa-trash"></i> Delete </a></td>
                        </tr>
	                @endforeach
	            </tbody>
	            <tfoot>
